...
// import PortalTransitionSection from '@/components/home-7/PortalTransitionSection'; // tạm ẩn
...
export default function HomePage() {
  // Curtain reveal: the hero is position: sticky and pins at the top while the
  // content block below (pulled up by -100dvh) slides over it. Mirrors
  // app/home-7/page.tsx so `/` and `/home-7` render identically.
  return (
    <>
